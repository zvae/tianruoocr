...
namespace TrOCR
{
	...
	public class HelpWin32
	{
		...
		public static bool CaptureWindow(Control control, ref Bitmap bitmap)
		{
			...
			var lParam = new IntPtr(12);
			var hdc = graphics.GetHdc();
			SendMessage(control.Handle, 791, hdc, lParam);
		...
		public class IniFileHelper
		{
			...
			public static string GetValue(string sectionName, string key, string filePath)
			{
				...
				var privateProfileString = GetPrivateProfileString(sectionName, key, "发生错误", array, 999, filePath);
