...
namespace TrOCR
{
	...
	public partial class AliFMtable : Form
	{
		...
		{
			var documentFromWindow = WebBrowserHelper.GetDocumentFromWindow(webBrowser1.Document.Window.Frames["alibaba-login-box"].DomWindow as IHTMLWindow2);
			var value = documentFromWindow.getElementById("fm-login-id").getAttribute("value", 0).ToString();
			var value2 = documentFromWindow.getElementById("fm-login-password").getAttribute("value", 0).ToString();
